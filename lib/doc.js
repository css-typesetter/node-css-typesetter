...
<html lang="cs">
  <head>
    ...
    .inner {
      display: block;
      width: ${context.innerwidth}cm;
      height: ${context.innerheight}cm !important;
      top: ${context.innertop}cm;
      left: ${context.innerleft}cm;
      position: relative;
      overflow: hidden;
    }
    </style>
...
exports.readLinkedDocs = readLinkedDocs
